...
//    csvReader->printResultInformation(); //打印result信息
    ...
    int partCount = 0;
    for(int i=rank;i<testDataSize;i+=num_procs){
    ...
    MPI_Reduce(&partCount,&count,1,MPI_DOUBLE,MPI_SUM,0,MPI_COMM_WORLD);
    if(rank == 0){
        endTime = MPI_Wtime();
 ...
 *
 *
60000 行 800 列的数据   用时 1011.74秒
The k value is：15,the all dataSet has 60000 pieces of data，the train Set has 40000,the test set has 20000
total 56 processes
this time the accuracy of dataSet is 84.155%
cost time 1011.74 seconds

10000 行 800列 用时26.8512
The k value is：15,the all dataSet has 10000 pieces of data，the train Set has 6666,the test set has 3334
total 56 processes
this time the accuracy of dataSet is 81.3137%
cost time 26.8512 seconds

10000 行 800列  用时27.2718
threadNum = 5
The k value is：15,the all dataSet has 10000 pieces of data，the train Set has 6666,the test set has 3334
total 56 processes
this time the accuracy of dataSet is 80.6539%
cost time 27.2718 seconds
