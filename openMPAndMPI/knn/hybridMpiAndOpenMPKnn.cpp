...
/*
混合的效率一定不会超过 单一mpi和openmp的工作效率  mpi和openmp的结合最适用于 多机多cpu的 集群环境
这样可以利用集群和mpi的消息传递 将整个超级计算机结合到一块
...
total 28 processes
this time the accuracy of dataSet is 81.0438%
cost time 28.2687 seconds
